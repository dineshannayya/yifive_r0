...
create_clock -name wbs_clk_i -period 10.0000      [get_pins {u_wb_host/u_wbs_clk_sel.u_mux/X}]
create_clock -name sdram_clk -period 20.0000      [get_pins {u_wb_host/u_clkbuf_sdram/X}]
create_clock -name sdram_pad_clk -period 20.0000  [get_ports {io_in[29]}]
create_clock -name cpu_clk -period 20.0000        [get_pins {u_wb_host/u_cpu_clk_sel.u_mux/X}]
create_clock -name rtc_clk -period 50.0000        [get_pins {u_wb_host/u_clkbuf_rtc/X}]
create_clock -name line_clk -period 100.0000      [get_pins {u_uart_i2c_usb/u_uart_core.u_lineclk_buf/X}]
create_clock -name user_clock2 -period 100.0000   [get_ports {user_clock2}]

create_generated_clock -name spiclk -add -source [get_pins {u_wb_host/u_wbs_clk_sel.u_mux/X}] -master_clock [get_clocks {wbs_clk_i}] -divide_by 2 -comment {SPI Clock Out} [get_ports {io_out[30]}]

set_clock_uncertainty -rise_from [get_clocks {wbm_clk_i}] -rise_to [get_clocks {wbm_clk_i}]      -hold  0.100
set_clock_uncertainty -rise_from [get_clocks {wbm_clk_i}] -rise_to [get_clocks {wbm_clk_i}]      -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {wbm_clk_i}] -fall_to [get_clocks {wbm_clk_i}]      -hold  0.100
set_clock_uncertainty -rise_from [get_clocks {wbm_clk_i}] -fall_to [get_clocks {wbm_clk_i}]      -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {wbm_clk_i}] -rise_to [get_clocks {wbm_clk_i}]      -hold  0.100
set_clock_uncertainty -fall_from [get_clocks {wbm_clk_i}] -rise_to [get_clocks {wbm_clk_i}]      -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {wbm_clk_i}] -fall_to [get_clocks {wbm_clk_i}]      -hold  0.100
set_clock_uncertainty -fall_from [get_clocks {wbm_clk_i}] -fall_to [get_clocks {wbm_clk_i}]      -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {wbs_clk_i}] -rise_to [get_clocks {wbs_clk_i}]      -hold  0.100
set_clock_uncertainty -rise_from [get_clocks {wbs_clk_i}] -rise_to [get_clocks {wbs_clk_i}]      -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {wbs_clk_i}] -fall_to [get_clocks {wbs_clk_i}]      -hold  0.100
set_clock_uncertainty -rise_from [get_clocks {wbs_clk_i}] -fall_to [get_clocks {wbs_clk_i}]      -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {wbs_clk_i}] -rise_to [get_clocks {wbs_clk_i}]      -hold  0.100
set_clock_uncertainty -fall_from [get_clocks {wbs_clk_i}] -rise_to [get_clocks {wbs_clk_i}]      -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {wbs_clk_i}] -fall_to [get_clocks {wbs_clk_i}]      -hold  0.100
set_clock_uncertainty -fall_from [get_clocks {wbs_clk_i}] -fall_to [get_clocks {wbs_clk_i}]      -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {sdram_clk}] -rise_to [get_clocks {sdram_clk}]      -hold  0.100
set_clock_uncertainty -rise_from [get_clocks {sdram_clk}] -rise_to [get_clocks {sdram_clk}]      -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {sdram_clk}] -fall_to [get_clocks {sdram_clk}]      -hold  0.100
set_clock_uncertainty -rise_from [get_clocks {sdram_clk}] -fall_to [get_clocks {sdram_clk}]      -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {sdram_clk}] -rise_to [get_clocks {sdram_clk}]      -hold  0.100
set_clock_uncertainty -fall_from [get_clocks {sdram_clk}] -rise_to [get_clocks {sdram_clk}]      -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {sdram_clk}] -fall_to [get_clocks {sdram_clk}]      -hold  0.100
set_clock_uncertainty -fall_from [get_clocks {sdram_clk}] -fall_to [get_clocks {sdram_clk}]      -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {sdram_pad_clk}] -rise_to [get_clocks {sdram_clk}]  -hold  0.100
set_clock_uncertainty -rise_from [get_clocks {sdram_pad_clk}] -rise_to [get_clocks {sdram_clk}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {sdram_pad_clk}] -fall_to [get_clocks {sdram_clk}]  -hold  0.100
set_clock_uncertainty -rise_from [get_clocks {sdram_pad_clk}] -fall_to [get_clocks {sdram_clk}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {sdram_pad_clk}] -rise_to [get_clocks {sdram_clk}]  -hold  0.100
set_clock_uncertainty -fall_from [get_clocks {sdram_pad_clk}] -rise_to [get_clocks {sdram_clk}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {sdram_pad_clk}] -fall_to [get_clocks {sdram_clk}]  -hold  0.100
set_clock_uncertainty -fall_from [get_clocks {sdram_pad_clk}] -fall_to [get_clocks {sdram_clk}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {cpu_clk}] -rise_to [get_clocks {cpu_clk}]          -hold  0.100
set_clock_uncertainty -rise_from [get_clocks {cpu_clk}] -rise_to [get_clocks {cpu_clk}]          -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {cpu_clk}] -fall_to [get_clocks {cpu_clk}]          -hold  0.100
set_clock_uncertainty -rise_from [get_clocks {cpu_clk}] -fall_to [get_clocks {cpu_clk}]          -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {cpu_clk}] -rise_to [get_clocks {cpu_clk}]          -hold  0.100
set_clock_uncertainty -fall_from [get_clocks {cpu_clk}] -rise_to [get_clocks {cpu_clk}]          -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {cpu_clk}] -fall_to [get_clocks {cpu_clk}]          -hold  0.100
set_clock_uncertainty -fall_from [get_clocks {cpu_clk}] -fall_to [get_clocks {cpu_clk}]          -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {rtc_clk}] -rise_to [get_clocks {rtc_clk}]          -hold  0.100
set_clock_uncertainty -rise_from [get_clocks {rtc_clk}] -rise_to [get_clocks {rtc_clk}]          -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {rtc_clk}] -fall_to [get_clocks {rtc_clk}]          -hold  0.100
set_clock_uncertainty -rise_from [get_clocks {rtc_clk}] -fall_to [get_clocks {rtc_clk}]          -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {rtc_clk}] -rise_to [get_clocks {rtc_clk}]          -hold  0.100
set_clock_uncertainty -fall_from [get_clocks {rtc_clk}] -rise_to [get_clocks {rtc_clk}]          -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {rtc_clk}] -fall_to [get_clocks {rtc_clk}]          -hold  0.100
set_clock_uncertainty -fall_from [get_clocks {rtc_clk}] -fall_to [get_clocks {rtc_clk}]          -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {line_clk}] -rise_to [get_clocks {line_clk}]        -hold  0.100
set_clock_uncertainty -rise_from [get_clocks {line_clk}] -rise_to [get_clocks {line_clk}]        -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {line_clk}] -fall_to [get_clocks {line_clk}]        -hold  0.100
set_clock_uncertainty -rise_from [get_clocks {line_clk}] -fall_to [get_clocks {line_clk}]        -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {line_clk}] -rise_to [get_clocks {line_clk}]        -hold  0.100
set_clock_uncertainty -fall_from [get_clocks {line_clk}] -rise_to [get_clocks {line_clk}]        -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {line_clk}] -fall_to [get_clocks {line_clk}]        -hold  0.100
...
set_clock_groups -name async_clock -asynchronous \
 ...
 -group [get_clocks {wbs_clk_i spiclk}] -comment {Async Clock group}

## WB_PORT Write to Read is multi-cycle 
set_multicycle_path -setup -from [get_ports {wbs_we_i} ]  -to [get_ports {wbs_ack_o}] 2
set_multicycle_path -hold -from [get_ports {wbs_we_i}]   -to [get_ports {wbs_ack_o}] 1

set_multicycle_path -setup -from [get_ports {wbs_we_i} ]  -to [get_ports {wbs_dat_o[*]}] 2
set_multicycle_path -hold -from [get_ports {wbs_we_i}]   -to [get_ports {wbs_dat_o[*]}] 1

set_multicycle_path -setup -from [get_ports {wbs_adr_i[*]} ]  -to [get_ports {wbs_ack_o}] 2
set_multicycle_path -hold -from [get_ports {wbs_adr_i[*]}]   -to [get_ports {wbs_ack_o}] 1

set_multicycle_path -setup -from [get_ports {wbs_adr_i[*]}]  -to [get_ports {wbs_dat_o[*]}] 2
set_multicycle_path -hold -from [get_ports {wbs_adr_i[*]}]   -to [get_ports {wbs_dat_o[*]}] 1

set_input_delay 2.0000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wb_rst_i}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[0]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[10]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[11]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[12]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[13]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[14]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[15]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[16]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[17]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[18]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[19]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[1]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[20]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[21]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[22]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[23]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[24]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[25]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[26]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[27]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[28]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[29]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[2]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[30]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[31]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[3]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[4]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[5]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[6]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[7]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[8]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_adr_i[9]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_cyc_i}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[0]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[10]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[11]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[12]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[13]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[14]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[15]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[16]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[17]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[18]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[19]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[1]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[20]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[21]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[22]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[23]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[24]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[25]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[26]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[27]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[28]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[29]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[2]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[30]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[31]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[3]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[4]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[5]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[6]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[7]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[8]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_i[9]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_sel_i[0]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_sel_i[1]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_sel_i[2]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_sel_i[3]}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_stb_i}]
set_input_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_we_i}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_ack_o}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[0]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[10]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[11]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[12]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[13]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[14]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[15]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[16]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[17]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[18]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[19]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[1]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[20]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[21]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[22]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[23]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[24]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[25]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[26]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[27]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[28]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[29]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[2]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[30]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[31]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[3]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[4]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[5]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[6]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[7]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[8]}]
set_output_delay 5.4000 -clock [get_clocks {wbm_clk_i}] -add_delay [get_ports {wbs_dat_o[9]}]

## SPI I/F
set_input_delay -max 5.0000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_in[32]}]
set_input_delay -max 5.0000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_in[33]}]
set_input_delay -max 5.0000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_in[34]}]
set_input_delay -max 5.0000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_in[35]}]

set_input_delay -min 0.0000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_in[32]}]
set_input_delay -min 0.0000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_in[33]}]
set_input_delay -min 0.0000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_in[34]}]
set_input_delay -min 0.0000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_in[35]}]

set_output_delay -max 4.0000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_out[31]}]
set_output_delay -max 4.0000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_out[32]}]
set_output_delay -max 4.0000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_out[33]}]
set_output_delay -max 4.0000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_out[34]}]
set_output_delay -max 4.0000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_out[35]}]

set_output_delay -min -0.5000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_out[31]}]
set_output_delay -min -0.5000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_out[32]}]
set_output_delay -min -0.5000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_out[33]}]
set_output_delay -min -0.5000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_out[34]}]
set_output_delay -min -0.5000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_out[35]}]

set_output_delay -max 4.0000  -clock [get_clocks {spiclk}] -add_delay [get_ports {io_oeb[30]}]
set_output_delay -max 4.0000  -clock [get_clocks {spiclk}] -add_delay [get_ports {io_oeb[31]}]
set_output_delay -max 4.0000  -clock [get_clocks {spiclk}] -add_delay [get_ports {io_oeb[32]}]
set_output_delay -max 4.0000  -clock [get_clocks {spiclk}] -add_delay [get_ports {io_oeb[33]}]
set_output_delay -max 4.0000  -clock [get_clocks {spiclk}] -add_delay [get_ports {io_oeb[34]}]
set_output_delay -max 4.0000  -clock [get_clocks {spiclk}] -add_delay [get_ports {io_oeb[35]}]

set_output_delay -min -0.5000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_oeb[30]}]
set_output_delay -min -0.5000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_oeb[31]}]
set_output_delay -min -0.5000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_oeb[32]}]
set_output_delay -min -0.5000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_oeb[33]}]
set_output_delay -min -0.5000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_oeb[34]}]
set_output_delay -min -0.5000 -clock [get_clocks {spiclk}] -add_delay [get_ports {io_oeb[35]}]

#SDRAM I/F
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[0]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[0]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[10]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[10]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[11]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[11]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[12]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[12]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[13]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[13]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[14]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[14]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[15]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[15]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[16]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[16]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[17]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[17]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[18]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[18]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[19]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[19]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[1]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[1]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[20]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[20]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[21]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[21]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[22]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[22]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[23]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[23]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[24]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[24]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[25]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[25]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[26]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[26]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[27]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[27]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[28]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[28]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[2]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[2]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[3]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[3]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[4]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[4]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[5]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[5]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[6]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[6]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[7]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[7]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[8]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[8]}]
set_input_delay 1.0000 -clock [get_clocks {sdram_pad_clk}] -min -add_delay [get_ports {io_in[9]}]
set_input_delay 12.0000 -clock [get_clocks {sdram_pad_clk}] -max -add_delay [get_ports {io_in[9]}]
...
set_case_analysis 1 [get_pins {u_spi_master/cfg_cska_spi[1]}]
set_case_analysis 1 [get_pins {u_spi_master/cfg_cska_spi[2]}]
set_case_analysis 0 [get_pins {u_spi_master/cfg_cska_spi[3]}]
