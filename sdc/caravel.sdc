...
create_clock -name user_clock2  -period 30.0000  [get_pins {mprj/u_wb_host/user_clock2}]
...
create_clock -name sdram_clk  -period 10.0000  [get_pins {mprj/u_wb_host/sdram_clk}]

create_clock -name usb_clk    -period 20.0000  [get_pins {mprj/u_wb_host/usb_clk}]

create_clock -name rtc_clk     -period 20.0000  [get_pins {mprj/u_wb_host/rtc_clk}]
...
## User Case analysis
#################################################################
set_case_analysis 0 [get_pins {mprj/u_skew_wi/sel[3]}]
set_case_analysis 0 [get_pins {mprj/u_skew_wi/sel[2]}]
set_case_analysis 1 [get_pins {mprj/u_skew_wi/sel[1]}]
set_case_analysis 0 [get_pins {mprj/u_skew_wi/sel[0]}]
...
set_case_analysis 0 [get_pins {mprj/u_skew_uart/sel[2]}]
set_case_analysis 0 [get_pins {mprj/u_skew_uart/sel[1]}]
set_case_analysis 0 [get_pins {mprj/u_skew_uart/sel[0]}]

set_case_analysis 0 [get_pins {mprj/u_skew_spi/sel[3]}]
set_case_analysis 1 [get_pins {mprj/u_skew_spi/sel[2]}]
set_case_analysis 1 [get_pins {mprj/u_skew_spi/sel[1]}]
set_case_analysis 0 [get_pins {mprj/u_skew_spi/sel[0]}]

set_case_analysis 1 [get_pins {mprj/u_skew_sdram/sel[3]}]
set_case_analysis 0 [get_pins {mprj/u_skew_sdram/sel[2]}]
set_case_analysis 0 [get_pins {mprj/u_skew_sdram/sel[1]}]
set_case_analysis 0 [get_pins {mprj/u_skew_sdram/sel[0]}]

set_case_analysis 0 [get_pins {mprj/u_skew_glbl/sel[3]}]
set_case_analysis 1 [get_pins {mprj/u_skew_glbl/sel[2]}]
set_case_analysis 0 [get_pins {mprj/u_skew_glbl/sel[1]}]
set_case_analysis 0 [get_pins {mprj/u_skew_glbl/sel[0]}]

set_case_analysis 1 [get_pins {mprj/u_skew_wh/sel[3]}]
set_case_analysis 0 [get_pins {mprj/u_skew_wh/sel[2]}]
set_case_analysis 0 [get_pins {mprj/u_skew_wh/sel[1]}]
set_case_analysis 0 [get_pins {mprj/u_skew_wh/sel[0]}]

# clock skew cntrl-2
set_case_analysis 0 [get_pins {mprj/u_skew_sd_co/sel[3]}]
set_case_analysis 0 [get_pins {mprj/u_skew_sd_co/sel[2]}]
set_case_analysis 0 [get_pins {mprj/u_skew_sd_co/sel[0]}]
set_case_analysis 0 [get_pins {mprj/u_skew_sd_co/sel[1]}]

set_case_analysis 0 [get_pins {mprj/u_skew_sd_ci/sel[3]}]
set_case_analysis 0 [get_pins {mprj/u_skew_sd_ci/sel[2]}]
set_case_analysis 0 [get_pins {mprj/u_skew_sd_ci/sel[0]}]
set_case_analysis 0 [get_pins {mprj/u_skew_sd_ci/sel[1]}]

set_case_analysis 0 [get_pins {mprj/u_skew_sp_co/sel[3]}]
set_case_analysis 0 [get_pins {mprj/u_skew_sp_co/sel[2]}]
set_case_analysis 0 [get_pins {mprj/u_skew_sp_co/sel[0]}]
set_case_analysis 0 [get_pins {mprj/u_skew_sp_co/sel[1]}]
